...
all_data = purrr::map(comp_files, 
                      phenoptrReports:::get_component_level_data, 
                      quantiles=quantiles)
...
purrr::iwalk(all_data, function(d, n) {
  message('Histogram for ', n)
  
  print(phenoptrReports:::component_ridge_plot(d$data, d$quants, d$clipping))
  cat('\n\n  \n----\n  \n')
})
...
palette = discrete_colors(length(fluors))
