...
#### Choose "Unmixing error report" from the RStudio Addins menu

Thus will open the error reporting app.

![](figures/Unmixing_error_addin.png)
...
![](figures/Create_unmixing_error_report.png)
...
a file `Unmixing_error_report.html` which may be viewed in any web browser.
