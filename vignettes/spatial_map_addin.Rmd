...
Nearest neighbor relationships are read from a `nearest_neighbors.csv` file.
This file is created by the "Analyze consolidated data" addin when 
...
to use to display the phenotypes. **Important!** Only single phenotypes
are supported. Double-positive phenotypes may not be used here.
