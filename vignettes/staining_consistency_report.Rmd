...
of staining across staining runs.
...
and limited outliers beyond the &plusmn;1 SD range. 

```{r, fig.alt = "Image showing good results", out.width="75%"}
knitr::include_graphics("figures/Staining_consistency_good.png")
```

A wide range of mean values and outliers far outside the &plusmn;1 SD range
indicate that the auto-stainer may need maintenance.
