...
report will include a tab summarizing nearest neighbor distances between
...
report will include a tab summarizing, for each pair of phenotypes,
...
- **Save nearest neighbor details** If this is selected, the analysis will
write a `nearest_neighbors.csv` file containing, for each cell, the
distance to the nearest cell of each phenotype and the cell ID of the cell.
This file is needed by the "Spatial map viewer" 
to visualize nearest neighbor distances and may be useful
for more detailed statistical analysis of 
nearest neighbor distances. *Select this option if you want
to use the Spatial map viewer later!*
