...
In this section, select the types of spatial analysis to include and options
for the spatial processing.
...
- **Process spatial metrics in parallel** If this is selected, the `futures`
package will be used to compute spatial metrics in parallel using multiple
processing cores. This is most helpful when the data contains many fields.
