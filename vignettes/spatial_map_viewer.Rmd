...
### Composite and component or segmentation map image files

The viewer uses both composite and component or segmentation map
image files for the fields of
...
The component or segmentation map images are the source of metadata about 
